                    ...
                    <ul class="list-unstyled vertical-icon-border box-list">
                        ...
                        <li class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <p class="text-left"><?php echo __('Finally, data is released trough the website, people can interrogate the platform to explore the different datasets or browse the results trough the agents available.');?></p>
                            </div>
                        </li>
                    </ul>
                </div>
