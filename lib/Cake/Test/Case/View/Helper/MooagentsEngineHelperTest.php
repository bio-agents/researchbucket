...
App::uses('MooagentsEngineHelper', 'View/Helper');

/**
 * Class MooagentsEngineHelperTest
 *
 * @package       Cake.Test.Case.View.Helper
 */
class MooagentsEngineHelperTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		...
		$this->Moo = new MooagentsEngineHelper($this->View);
	}
